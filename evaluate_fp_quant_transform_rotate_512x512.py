...
if __name__ == "__main__":
    ...
    if args.transform == True:
        ...
        if args.w_bit == 4:
            mat_qkv_best_s = torch.load(f"/home/rjwei/Data_raid/Q-VAR/best_s_512x512/mat_qkv_best_s_fp4.pt", map_location=device)
            fc1_best_s = torch.load(f"/home/rjwei/Data_raid/Q-VAR/best_s_512x512/fc1_best_s_fp4.pt", map_location=device)
        elif args.w_bit == 6:
            mat_qkv_best_s = torch.load(f"/home/rjwei/Data_raid/Q-VAR/best_s_512x512/mat_qkv_best_s_fp6.pt", map_location=device)
            fc1_best_s = torch.load(f"/home/rjwei/Data_raid/Q-VAR/best_s_512x512/fc1_best_s_fp6.pt", map_location=device)
        else:
    ...
    save_file_path = f'/home/rjwei/Data_raid/512x512_img/evaluate_figs_new_transform_and_block_rotate_fp4_quant_e2m1_fc2_special_w{args.w_bit}_{args.weight_quant}_a{args.a_bit}_{args.act_quant}_kv{args.kv_bit}' 
