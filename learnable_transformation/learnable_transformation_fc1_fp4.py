...
if __name__ == "__main__":
    ...
    #         torch.save(activation_tensor, f"/home/rjwei/Data_raid/Q-VAR/cali_data/learnable_s/fc1_block{block_idx}_step{step_idx}.pt")
    ...
    for block_idx in range(30):
        ...
        activation = []
        for step_idx in range(10):
            x = torch.load(f"/home/rjwei/Data_raid/Q-VAR/cali_data/learnable_s/fc1_block{block_idx}_step{step_idx}.pt", map_location=device)
            activation.append(x)
            weight = torch.load(f"/home/rjwei/Data_raid/Q-VAR/var30_weights/blocks.{block_idx}.ffn.fc1.pt", weights_only=True, map_location=device)
    ...
    torch.save(learnable_s_fc1, f"/home/rjwei/Data_raid/Q-VAR/best_s/fc1_best_s_fp4.pt")