...
if __name__ == "__main__":
    ...
    #             file_name = f"/home/rjwei/Data_raid/Q-VAR/cali_data_512x512/mat_qkv_input/label{label_idx}_block{block_idx}_step{step_idx}_mat_qkv_input.pt"
    #             x_fp = torch.load(file_name).to(device)
    #             activation.append(x_fp)

    #         activation_tensor = torch.stack(activation)
    #         torch.save(activation_tensor, f"/home/rjwei/Data_raid/Q-VAR/cali_data_512x512/learnable_s/mat_qkv_block{block_idx}_step{step_idx}.pt")
    ...
    pdb.set_trace()
    torch.save(learnable_s_mat_qkv, f"/home/rjwei/Data_raid/Q-VAR/best_s/mat_qkv_best_s_fp4.pt")