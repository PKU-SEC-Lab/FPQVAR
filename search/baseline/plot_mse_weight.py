...
# filename = "weight_mse.ffn.fc2"
# filename = "weight_mse.ffn.fc1"
filename = "weight_mse.attn.mat_qkv"
# filename = "weight_mse.attn.proj"
# filename = "weight_mse.ada"
...
avg_e1m2 = sum(e1m2_mse) / len(e1m2_mse)
avg_e2m1 = sum(e2m1_mse) / len(e2m1_mse)

print(f"e1m2_mse 平均值: {avg_e1m2}")
print(f"e2m1_mse 平均值: {avg_e2m1}")
