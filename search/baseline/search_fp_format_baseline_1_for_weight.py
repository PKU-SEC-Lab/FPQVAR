...
if __name__ == '__main__':
    ...
    for block_idx in range(30):
        ...
        # INT4 quantization
        w_int_quant = quantize_activation_per_group_sym(w_fp, 4, 128)
        loss = compute_quant_error(w_fp, w_int_quant)
        ...
        for format in formats:
            w_quant = FPQuant.apply(w_fp, 4, 128, format)
        ...
        print(optim_format)
        optim_formats.append(optim_format)
    
    # torch.save(mse, "weight_mse.ffn.fc2.pt")
    # torch.save(mse, "weight_mse.ffn.fc1.pt")
    # torch.save(mse, "weight_mse.attn.proj.pt")
    # torch.save(mse, "weight_mse.attn.mat_qkv.pt")
    torch.save(mse, "weight_mse.ada.pt")
